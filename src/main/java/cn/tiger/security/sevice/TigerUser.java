...
public class TigerUser extends User {
     ...
     */
    public TigerUser(Integer id, List<IdentityEntity> identityEntityList, String username, String password, boolean enabled, boolean accountNonExpired,
                     boolean credentialsNonExpired, boolean accountNonLocked,
                     Collection<? extends GrantedAuthority> authorities) {
        super(username, password, enabled, accountNonExpired, credentialsNonExpired, accountNonLocked, authorities);
        this.id = id;
        this.identityEntityList = identityEntityList;
    }
}
